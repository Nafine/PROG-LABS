package se.ifmo.system.socket;

import se.ifmo.system.collection.CollectionManager;
import org.apache.commons.lang3.SerializationUtils;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import se.ifmo.client.communication.Router;
...
/**
 * A multithreaded server for handling client connections and processing requests.
 *
...
public final class Server implements AutoCloseable, Runnable {
     ...
     * @param console       the {@link Console} for handling administrative commands via the console.
     * @throws NullPointerException if {@code configuration} or {@code console} is {@code null}.
     */
    public Server(ServerConfiguration configuration, Console console) {
     ...
     * generating an appropriate {@link Callback}, and queuing it for sending back to the client.</p>
     *
     * <p>Workflow:</p>
     * <ul>
    ...
    private static class ClientData {
         ...
         *
         * <p>This method serializes the given {@link Callback} object, wraps the serialized
         ...
         * <p>Workflow:</p>
         * <ul>
         *     <li>The {@link Callback} object is serialized to a byte array.</li>
         ...
         * </ul>
         *
         * @param callback the {@link Callback} object to be queued for the client.
         */
        public void queueResponse(Callback callback) {
